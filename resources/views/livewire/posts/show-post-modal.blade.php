        ...
        <article>
            <div class="flex items-center mb-4 space-x-4">
                <div class="space-y-1 font-medium">
                    <p>{{ $title }} <span class="block text-sm text-gray-500">{{ $category }}</span></p>
                </div>
            </div>
            <div class="flex items-center mb-1">
                ...
                <p class="ml-2 text-sm font-bold text-gray-900">4.21</p>
            </div>
            <footer class="text-sm text-gray-500">
                <p>Written by {{ $author }} on {{ $created_at }}</p>
            </footer>
            <hr class="my-4 mx-auto w-1/2 h-px bg-gray-100 rounded border-0 md:my-10">
            <p class="mb-10 font-light text-gray-500 whitespace-pre-line">{{ $post_text }}</p>
            <aside>
                <p class="mt-1 text-xs text-gray-500">19 people liked this post</p>
                <div class="flex items-center mt-3 space-x-3 divide-x divide-gray-200">
                    <a href="#" class="inline-flex items-center text-sm text-blue-600 font-medium hover:underline"> {{-- text-slate-500 --}}
                    ...
                    <a href="#" class="pl-4 inline-flex items-center text-sm text-red-600 font-medium hover:underline group">
