                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('posts.update', $post) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" :value="old('title', $post->title)" autofocus />
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="post_text" name="post_text" type="text"
                                class="mt-1 h-60 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                autofocus>{{ old('post_text', $post->post_text) }}</textarea>
